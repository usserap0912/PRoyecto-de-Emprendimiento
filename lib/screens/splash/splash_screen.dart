...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _navTimer = Timer(const Duration(seconds: 4), () async {
      ...
      final existingZone = preferences.getInt('user_zone');

      final hasSelectableZone =
          existingZone != null && existingZone >= 1 && existingZone <= 10;

      if (existingCode != null && hasSelectableZone) {
        await SupabaseService().ensureLegacyProfile(
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (_) =>
                HomeScreen(userCode: existingCode, zone: existingZone),
          ),
        );
      } else {
      ...
      builder: (context, child) {
        return Row(
          ...
          children: List.generate(3, (index) {
            ...
            final dotValue = ((_dotsController.value - delay) % 1.0).clamp(
              0.0,
              1.0,
            );
